...
const ProductForm: React.FC<ProductFormProps> = ({ product, affiliates, niches, onSave, onClose }) => {
  ...
  // Calcolo Profitto COD (Indipendente)
  ...
  // Calcolo Profitto CARTA (Indipendente con Fallback su COD se Card cost = 0)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const productData: Partial<Product> & { imageFile?: File | null, newImageFiles?: File[] } = { 
        ...
        paccofacile_default_size: paccofacileDefaultSize,
      ...
      <div className="space-y-6">
          ...
          <div className="p-4 border rounded-md bg-gray-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div>
                    <label htmlFor="costOfGoods" className="block text-sm font-medium text-gray-700">Costo di Acquisto Merce (€)</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-4 bg-orange-50 rounded-xl border-2 border-orange-100">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="price" className="block text-xs font-bold text-gray-600">Prezzo di Vendita (€)</label>
                        ...
                        <div>
                            <label htmlFor="commissionValue" className="block text-xs font-bold text-gray-600">Provvigione Affiliato (€)</label>
                        ...
                        <div>
                            <label htmlFor="shippingCost" className="block text-xs font-bold text-gray-600">Costo Spedizione NOSTRO (€)</label>
                        ...
                        <div>
                            <label htmlFor="shippingCharge" className="block text-xs font-bold text-gray-600">Costo Spedizione CLIENTE (€)</label>
                            <input type="number" id="shippingCharge" value={shippingCharge} onChange={(e) => setShippingCharge(parseFloat(e.target.value) || 0)} min="0" step="0.01" className="mt-1 block w-full px-3 py-2 bg-white border border-orange-200 rounded-md text-sm" />
                        </div>
                        <div className="pt-2 border-t border-orange-100">
                             <div>
                                <label htmlFor="fulfillmentCost" className="block text-xs font-bold text-gray-600">Costo Logistica (Fissa) (€)</label>
                            ...
                            <div>
                                <label htmlFor="platformFee" className="block text-xs font-bold text-gray-600">Fee Piattaforma (€)</label>
                            ...
                            <div>
                                <label htmlFor="customerCareCommission" className="block text-xs font-bold text-gray-600">Commissione Customer Care (Fissa) (€)</label>
                ...
                <div className="p-4 bg-blue-50 rounded-xl border-2 border-blue-100">
                    <h4 className="text-xs font-black text-blue-600 uppercase mb-4 tracking-widest flex items-center gap-2">
                         ...
                         B. Logistica Carta (Elettronico)
                    </h4>
                    <div className="space-y-4">
                         <div>
                            <label htmlFor="priceCard" className="block text-xs font-bold text-gray-600">Prezzo di Vendita (€)</label>
                        ...
                        <div>
                            <label htmlFor="commissionValueCard" className="block text-xs font-bold text-gray-600">Provvigione Affiliato (€)</label>
                        ...
                        <div>
                            <label htmlFor="shippingCostCard" className="block text-xs font-bold text-gray-600">Costo Spedizione NOSTRO (€)</label>
                        ...
                        <div>
                            <label htmlFor="shippingChargeCard" className="block text-xs font-bold text-gray-600">Costo Spedizione CLIENTE (€)</label>
                            <input type="number" id="shippingChargeCard" value={shippingChargeCard} onChange={(e) => setShippingChargeCard(parseFloat(e.target.value) || 0)} min="0" step="0.01" className="mt-1 block w-full px-3 py-2 bg-white border border-blue-200 rounded-md text-sm" />
                        </div>
                        <div className="pt-2 border-t border-blue-100">
                             <div>
                                <label htmlFor="fulfillmentCostCard" className="block text-xs font-bold text-gray-600">Costo Logistica (Fissa) (€)</label>
                            ...
                            <div>
                                <label htmlFor="platformFeeCard" className="block text-xs font-bold text-gray-600">Fee Piattaforma (€)</label>
                            ...
                            <div>
                                <label htmlFor="customerCareCommissionCard" className="block text-xs font-bold text-gray-600">Commissione Customer Care (Fissa) (€)</label>
                        ...
                        <div className="pt-4 border-t border-blue-200">
                            <div className="flex justify-between items-center">
                                ...
                                <span className={`text-lg font-black ${estimatedNetProfitCard >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                                    €{estimatedNetProfitCard.toFixed(2)}
                                </span>
                            </div>
                        </div>
                    </div>
          ...
          <div className="p-4 border rounded-md bg-gray-50">
              ...
              <div className="space-y-4">
                  {bundles.map((bundle, index) => {
                      const totalRevenue = bundle.price + (freeShipping ? 0 : shippingCharge);
                      const totalCosts = (costOfGoods * bundle.quantity) + shippingCost + fulfillmentCost + customerCareCommission + bundle.commissionValue + (bundle.platformFee || 0);
                      const bundleProfit = totalRevenue - totalCosts;
                      return (
                      <div key={index} className="p-3 border rounded-md bg-white relative">
                          ...
                          <div className="mt-3 pt-3 border-t border-gray-200">
                              <div className="flex justify-between items-center">
                                  <span className="text-xs font-bold text-gray-700">Profitto Netto Stimato (COD):</span>
