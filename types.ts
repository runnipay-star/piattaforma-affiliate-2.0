...
export type ContactAction = 'welcome_message' | 'giacenza_redelivery' | 'giacenza_pickup' | 'giacenza_find_depot' | 'out_of_stock_delay' | 'last_warning' | 'refund_request';
...
export interface Sale {
  ...
  contactHistory?: ContactHistoryItem[]; isBonus?: boolean;
  webhookUrl?: string;
...
export type View = 'login' | 'dashboard' | 'products' | 'product-detail' | 'affiliates' | 'orders' | 'managers' | 'performance' | 'profile' | 'notifications' | 'notification-detail' | 'pagamenti' | 'assistenza' | 'ticket-detail' | 'settings' | 'contabilita' | 'magazzino' | 'general-calculations';